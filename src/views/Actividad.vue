  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        ...
        p.mb-4 Lograr la satisfacción del cliente es indispensable para obtener un lugar en su corazón. Este proceso solo puede ser posible si se aplica la mejora continua en los servicios, identificando sus debilidades y las fortalezas a potenciar.
